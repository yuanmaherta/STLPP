...
import { Users, FileText, CheckCircle2, AlertCircle, Search } from 'lucide-react';

export default function AdminDashboardPage() {
  // TODO: ganti mockEmployees ini dengan query asli ke Supabase (tabel employees + evaluations)
  const mockEmployees = [
    ...
    <div>
      <header className="mb-8 flex flex-col md:flex-row md:items-center md:justify-between bg-white p-6 rounded-xl shadow-sm border border-slate-200">
        ...
        <div className="mt-4 md:mt-0 flex items-center gap-3">
          <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-amber-50 text-amber-700 text-xs font-semibold border border-amber-200">
            <span className="w-2 h-2 rounded-full bg-amber-500 animate-pulse"></span>
            Data contoh (belum tersambung Supabase)
          </span>
        </div>
      </header>
